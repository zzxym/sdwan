...
const protos = { tcp: 11010, udp: 11010, wg: 11011, ws: 11011, wss: 11012 };
...
function __VLS_template() {
    ...
    if (__VLS_ctx.curNetwork.networking_method === __VLS_ctx.NetworkingMethod.Manual) {
        ...
        // @ts-ignore
        const __VLS_55 = __VLS_asFunctionalComponent(__VLS_54, new __VLS_54({ ...{ 'onComplete': {} }, id: ("chips"), modelValue: ((__VLS_ctx.curNetwork.peer_urls)), placeholder: ((__VLS_ctx.t('chips_placeholder', ['tcp://8.8.8.8:11010']))), ...{ class: ("grow") }, multiple: (true), fluid: (true), suggestions: ((__VLS_ctx.peerSuggestions)), }));
        const __VLS_56 = __VLS_55({ ...{ 'onComplete': {} }, id: ("chips"), modelValue: ((__VLS_ctx.curNetwork.peer_urls)), placeholder: ((__VLS_ctx.t('chips_placeholder', ['tcp://8.8.8.8:11010']))), ...{ class: ("grow") }, multiple: (true), fluid: (true), suggestions: ((__VLS_ctx.peerSuggestions)), }, ...__VLS_functionalComponentArgsRest(__VLS_55));
        let __VLS_60;
        const __VLS_61 = {
