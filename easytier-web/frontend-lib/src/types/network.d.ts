export declare enum NetworkingMethod {
    PublicServer = 0,
    Manual = 1,
    Standalone = 2
}
...
export declare function DEFAULT_NETWORK_CONFIG(): NetworkConfig;
...
export declare const addRow: (rows: PortForwardConfig[]) => void;
export declare const removeRow: (index: number, rows: PortForwardConfig[]) => void;
