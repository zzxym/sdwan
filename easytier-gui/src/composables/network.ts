...
type NetworkConfig = import('sdwan-frontend-lib').NetworkTypes.NetworkConfig
type NetworkInstanceRunningInfo = import('sdwan-frontend-lib').NetworkTypes.NetworkInstanceRunningInfo
