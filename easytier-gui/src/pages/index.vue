...
import { Config, Status, Utils, I18nUtils, ConfigEditDialog } from 'sdwan-frontend-lib'
...
const curNetworkConfig = computed(() => {
  if (networkStore.curNetworkId) {
    ...
    const c = networkStore.networkList.find((n: any) => n.instance_id === networkStore.curNetworkId)
    if (c !== undefined)
      return c
  }
